...
export function ProjectCard({
  ...
  return (
    <div className={`
      project-card rounded-2xl overflow-hidden bg-white/5 dark:bg-white/5
    ...
    `}>
      ...
      <div className="project-content p-6">
        <div className="project-category text-gray-800 dark:text-white text-sm font-semibold mb-2">{category}</div>
        <h3 className="project-title text-xl font-bold mb-2 text-gray-800 dark:text-white">{title}</h3>
        <p className="text-gray-700 dark:text-white text-sm">{description}</p>
      </div>
    </div>
  );
}