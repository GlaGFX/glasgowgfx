  ...
  return (
    ...
    `}>
      ...
      <div className="project-content p-6">
        <div className="project-category text-black dark:text-white text-sm font-semibold mb-2">{category}</div>
        <h3 className="project-title text-xl font-bold mb-2 text-black dark:text-white">{title}</h3>
        <p className="text-gray-800 dark:text-gray-200 text-sm">{description}</p>
      </div>
    </div>
  );
}